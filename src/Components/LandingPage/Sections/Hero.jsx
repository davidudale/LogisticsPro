    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-16 sm:pb-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/*<h4 className="text-xl mt-[20px] sm:text-6xl lg:text-5xl font-syncopate font-bold leading-[1.02] mb-6 sm:mb-8 tracking-tight text-white">
            <span className="uppercase text-7xl">O</span>rchestrate deliveries with <span className="text-amber-600">real-time control.</span> 
          </h4>*/}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            ...
            >
              <input
                ...
                className="w-full sm:w-72 px-5 py-4 sm:py-5 rounded-xl border border-slate-700 bg-white/10 backdrop-blur-sm text-white placeholder:text-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/60 focus:border-orange-500/60"
              />
              <button
                className="w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 bg-orange-600 hover:bg-orange-700 text-white font-bold uppercase tracking-[0.16em] text-xs sm:text-sm transition-all hover:shadow-[0_0_20px_rgba(234,88,12,0.4)] rounded-xl"
                type="submit"
              >
                Track
              </button>
            </form>
            <button className="w-full bg-slate-800  sm:w-auto px-8 sm:px-10 py-4 sm:py-5 border border-slate-700 hover:border-slate-500 backdrop-blur--white font-bold uppercase tracking-[0.16em] text-xs text-white sm:text-sm  transition-all rounded-xl" type="button">
              Request a Demo
            </button>
          </div>
        </div>
