...
import { Activity, ClipboardList, Package, Truck } from "lucide-react";
...
const Drivers = () => {
  ...
  const stats = [
    { label: "Assigned Loads", value: "11", icon: ClipboardList },
    { label: "In Transit", value: "7", icon: Truck },
    { label: "Deliveries", value: "4", icon: Package },
        ...
        <main className="flex-1 ml-16 lg:ml-64 p-4 lg:p-8 min-h-[calc(100vh-65px)] overflow-y-auto bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-slate-900/50 via-slate-950 to-slate-950">
          <div className="max-w-7xl mx-auto">
            <header className="mb-8">
              <h1 className="text-3xl font-bold text-white tracking-tight">Driver Overview</h1>
              <p className="text-slate-400 text-sm mt-1">
                Route assignments, live delivery status, and shift activity.
              </p>
            </header>
